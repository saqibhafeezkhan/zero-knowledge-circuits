...
contract PlonkVerifier {
    ...
    uint256 constant Qmx  = 15017041536641970578044747079212335164177542961655834641851821531702115047106;
    uint256 constant Qmy  = 19628039628477045680915196605216321824212053277870696135438523832348749116257;
    uint256 constant Qlx  = 7008953129339731018429140153268053907740824467099842848404307016856793883649;
    uint256 constant Qly  = 9429871936243365811181824083107676835942068227706940292959499452798768181274;
    uint256 constant Qrx  = 14882708442140643080478411422835010791903431734067405568842567975866447044809;
    uint256 constant Qry  = 8009334574797373896753535282948016078093144433237415111219333750104943990836;
    uint256 constant Qox  = 1858819999572536682301696634783489760529725531385749689482065124022052040120;
    uint256 constant Qoy  = 12708001229743052083500487906048325113105802227822145053748701673354909787291;
    uint256 constant Qcx  = 19947166941749677670436527259417928758659773762716979687257542321787715970646;
    uint256 constant Qcy  = 177256042808007816805233671167663709814230903916159761245277029908291266173;
    uint256 constant S1x  = 18494071006560003071439649996274547301223742927212488563880942764215918067789;
    uint256 constant S1y  = 6639898288878840578328365735494488323682807754629099512334925488049506316064;
    uint256 constant S2x  = 13487984861984371780272377490475496740749791928538543918980844123564872003349;
    uint256 constant S2y  = 19449107501770492628374640913035439151301977909466544670878311719588319996480;
    uint256 constant S3x  = 18833349995739982838626869177712025460383289933092934427404438212461860839349;
    uint256 constant S3y  = 13424332097361108106274883597174148719824812410097728510379690257345018894294;
    uint256 constant k1   = 2;
    uint256 constant k2   = 3;
    uint256 constant X2x1 = 13113910014222348172878476927671505043340931952508654204946652902334684274833;
    uint256 constant X2x2 = 2725315430411180077533160924377577754216448275153191977180423398916141525129;
    uint256 constant X2y1 = 10141476285374470343824721490837207025704146285177498741460684399411014918111;
    uint256 constant X2y2 = 4154764201153627540849396440902447796558014618945779276488722368071533047485;
